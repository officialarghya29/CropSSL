...
"""
Rice Leaf Disease Dataset loader.

RiceLeaf dataset contains images of rice leaf diseases including
bacterial leaf blight, brown spot, and leaf blast.
"""
...
class RiceLeafDataset(Dataset):
    ...
    Args:
        root: Root directory containing rice leaf data.
    ...
    def __init__(
        ...
        self.data_dir = self.root / "RiceLeaf"
        if not self.data_dir.exists():
            print(f"RiceLeaf not found at {self.data_dir}. Creating synthetic dataset...")
